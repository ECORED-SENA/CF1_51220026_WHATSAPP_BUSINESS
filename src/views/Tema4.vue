...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p(data-aos="fade-up") Los contenidos digitales se definen como toda la información que se tiene disponible para mostrar en un medio digital, ya sea app, plataforma o red social. Tienen la posibilidad de estar formados por textos, imágenes, videos, mapas, formatos de redes sociales, como stories o reels. Estos contenidos son claves para alimentar la narrativa transmedia que se construya a partir de los diferentes medios digitales donde se aborde algún tipo de comunicación o interacción.

    p.mt-4(data-aos="fade-up") #[strong Los siguientes son ejemplos de contenidos digitales:]
    ...
    .row.mt-4
      ...
      .row.m-0.col-lg-3.mb-lg-0.mt-4
        .col-auto.p-3(style="background-color:#006475;")
          figure
            img(src="@/assets/curso/tema4/5.svg" data-aos="fade-right")
        .col.p-3.d-flex.align-items-center(style="background-color:#D8F5F2;border-top-right-radius:10px;border-bottom-right-radius:10px;")
          p.mb-0(data-aos="fade-up") #[strong Imágenes]
      .row.m-0.col-lg-3.mb-lg-0.mt-4
        .col-auto.p-3(style="background-color:#006475;")
          figure
            img(src="@/assets/curso/tema4/6.svg" data-aos="fade-right")
        .col.p-3.d-flex.align-items-center(style="background-color:#D8F5F2;border-top-right-radius:10px;border-bottom-right-radius:10px;")
          p.mb-0(data-aos="fade-up") #[strong Infografías]
      .row.m-0.col-lg-3.mb-lg-0.mt-4
        .col-auto.p-3(style="background-color:#006475;")
          figure
      ...
      .row.m-0.col-lg-3.mb-lg-0.mt-4
        ...
        .col.p-3.d-flex.align-items-center(style="background-color:#D8F5F2;border-top-right-radius:10px;border-bottom-right-radius:10px;")
          p.mb-0(data-aos="fade-up") #[strong Videos]
    ...
    .titulo-segundo
      h2#t_4_1 4.1 Plantillas gratuitas para el diseño de piezas gráficas
    ...
    .row.mt-5.p-3(style="background: rgb(255,242,208);background: linear-gradient(90deg, rgba(255,242,208,1) 29%, rgba(255,255,255,1) 29%);")
      .col-auto(style="place-self:center")
        figure
          img(src="@/assets/curso/tema4/17.svg" data-aos="fade-right")
    ...
    p.mt-5(data-aos="fade-up") #[strong En el material complementario, encontrará tutoriales que explican el manejo de cada una de estas aplicaciones.] 

    Separador.mt-5

    .titulo-segundo
      h2#t_4_2 4.2 Herramientas de apoyo (sitio web, redes sociales, correo electrónico y blog)

    .row
      .col-xl-4.mb-5.mb-xl-0(style="place-self:center")
        figure
          img(src="@/assets/curso/tema4/22.png" data-aos="fade-right")
      .col-xl-8(style="place-self:center")
        p(data-aos="fade-up") Existen muchos ejemplos de medios de comunicación digital a los cuales el público objetivo está expuesto a menudo en los entornos virtuales, tales como portales web, bases de datos en línea, blogs, redes sociales, e-books, entre otros. 
        .cajon.color-acento-contenido.p-4.mt-4(style="background-color:#FFF5D9;")
          p.mb-0(data-aos="fade-up") El propósito de la comunicación digital es asegurarse de que dichos mensajes sean entregados a sus destinatarios por medio de diferentes herramientas y estrategias que logren cautivar al público objetivo. Una de las principales características de la comunicación digital es que se puede llevar un mensaje por medio de diferentes canales de manera simultánea. 

    p.mt-5(data-aos="fade-up") Adicionalmente, el mensaje puede moldearse en tiempo real según el tipo de interacción que este tenga con el cliente, y dependiendo del tipo de retroalimentación que recibe por parte de este. Así como este tipo de comunicación permite cambios inmediatos de su forma y contenido, de igual manera se enfrenta al reto de la evolución de las tendencias y los intereses cambiantes de los clientes que habitan el entorno digital, que se caracteriza por su rápido cambio. #[strong De allí la importancia de las narrativas transmedia de suceder simultáneamente en diferentes medios digitales:]
    ...
    .titulo-segundo
      h2#t_4_3 4.3 Envío de mensajes masivos
    ...
    .row
      ...
      .col-xl-4
        figure
          img(src="@/assets/curso/tema4/26.png" data-aos="fade-left")
    ...
    .titulo-segundo
      h2#t_4_4 4.4 Catálogos y otras publicaciones
    ...
    figure.mt-4
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/Dci935CxKY4" title="Configuración del catálogo WhatsApp Business" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
