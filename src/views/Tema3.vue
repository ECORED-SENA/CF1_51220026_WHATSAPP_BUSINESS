...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-segundo
      h2#t_3_1 3.1 Propuesta gramatical
    ...
    p.mt-5(data-aos="fade-up") Las emociones son también un factor importante dentro del proceso de atención y toma de decisiones. Por eso, muchas de las estrategias narrativas apelan directamente a ellas e, incluso, pueden tomar acciones provocativas, que impulsen la decisión de compra. Es importante saber a qué tipo de necesidad se quiere apelar: fisiológicas, de seguridad, sociales, reconocimiento, autorrealización, o una combinación de estas. Asimismo, se deben identificar las palabras claves que mejor se relacionen con estas necesidades. 

    Separador.mt-5

    .titulo-segundo
      h2#t_3_2 3.2 #[em Big data] y clasificación de datos de #[em WhatsApp]
    ...
    .row.mt-5.p-4(style="background-color:#FFD76A;border-radius:10px")
      .col(style="place-self:center")
        p.mb-0(data-aos="fade-up") #[em WhatsApp API] permite la gestión de grandes bases de datos, pero se necesitará un desarrollador especializado o un ingeniero de sistemas para poder hacer uso de esta información de manera adecuada, este desarrollador, por lo general, lo dispone el tercero que se contrata para administrar la API de #[em WhatsApp].
      .col-auto(style="place-self:center")
        figure
          img(src="@/assets/curso/tema3/14.svg" data-aos="fade-left")

    p.mt-5(data-aos="fade-up") #[strong Las empresas con más éxito con #[em Big data] consiguen valor de las siguientes formas:]
     ...
     .row.mt-5
      .col-xl-4.mb-5.mb-xl-0
        .h-100(style="background-color:#FFF1CB;border-bottom-right-radius:15px;border-bottom-left-radius:15px;")
          ...
          .p-4.pt-4
            p(data-aos="fade-up") #[strong Reducción de costos]
            p.mt-3(data-aos="fade-up") A partir del análisis de #[em metadata] financiera, de ventas, compras y proveedores, se pueden establecer niveles de operación que garanticen la estabilidad de la compañía. 
      .col-xl-4.mb-5.mb-xl-0
        .h-100(style="background-color:#B2ECE6;border-bottom-right-radius:15px;border-bottom-left-radius:15px;")
          ...
          .p-4.pt-4
            p(data-aos="fade-up") #[strong Toma de decisiones]
            p.mt-3(data-aos="fade-up") Cuando la compañía vaya a tomar decisiones importantes, el acceso a bases de datos complejas proporciona evidencia tangible para poner a prueba dichas decisiones.
      .col-xl-4.mb-5.mb-xl-0
        .h-100(style="background-color:#B1CFD5;border-bottom-right-radius:15px;border-bottom-left-radius:15px;")
          ...
          .p-4.pt-4
            p(data-aos="fade-up") #[strong Nuevos productos y servicios]
            p.mt-3(data-aos="fade-up") A partir del conocimiento actualizado de las necesidades del cliente y de su posterior análisis, se pueden desarrollar nuevos productos y servicios. Incluso, al someterse a un nivel de datos tan masivo, se pueden ofrecer experiencias personalizadas para cada usuario y garantizar niveles más altos de satisfacción.
      ...
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          ...
          .p-4(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Impacto visual]
            p Historias visuales impactantes con textos llamativos y colores brillantes.
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          img(src="@/assets/curso/tema3/20.png")
          .p-4(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Escritura amigable]
            p Frases motivacionales, que tengan relación con la compañía o estrategia comunicacional.
      .col-xl-4.col-lg-6.mb-4.mb-lg-0
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          img(src="@/assets/curso/tema3/21.png")
          .p-4.pt-2.pb-2(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Imágenes poderosas]
            p.mb-0 Fotos e imágenes que muestran el desarrollo de las actividades del negocio, desde el proceso de producción hasta cubrimientos de eventos que se realicen.
      ...
      .col-xl-4.col-lg-6.mt-4
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
          ...
          .p-4.pt-4.pb-3(style="background-color:#00C1AB;position:absolute;width:100%;bottom:0;")
            p #[strong Realidad]
            p.mb-0 Contenido tras escenas que muestre la preparación de algún producto o la vida diaria de un empleado, colaborador, o directivo de la compañía.
      .col-xl-4.col-lg-6.mt-4
        figure.cont_tarjeta_1(data-aos="zoom-in-up" style="position:relative;")
...
.linea-tiempo-d__item.row.linea-tiempo-d__item--selected .tarjeta--gris
